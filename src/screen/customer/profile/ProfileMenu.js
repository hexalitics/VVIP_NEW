...
class ProfileMenu extends Component {
  ...
  logout = async () => {
    ...
    await this.props.saveAuthReducersData('user', {});
    await this.props.saveAuthReducersData('authToken', '');
    await this.props.saveAuthReducersData('profileImage', '');
    await this.props.saveAuthReducersData('profileName', '');
